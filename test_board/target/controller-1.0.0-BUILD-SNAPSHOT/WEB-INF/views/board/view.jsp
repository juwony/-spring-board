...
<article>
	<div class="container" role="main">
		...
		<div class="my-3 p-3 bg-white rounded shadow-sm" style="paddig-top: 10px;">
			<!-- 댓글 조회 -->
			<div class="col-md-12 reply_info_box">
						...
						<li class="list-group-item" style="border: none;">
							<div>
								...
								<c:if test="${member.userName == reply.writer}">
									<button type="button" class="btn btn-sm btn-primary replyUpdate" data-rno="${reply.rno}" id="replyUpdate">수정</button>
									<button type="button" class="btn btn-sm btn-primary replyDelete" data-rno="${reply.rno}" id="replyDelete">삭제</button>
			...
			<form name = "replyForm" method="post" action="/reply/write">
				...
				<div class="row">
					...
					<div class="col-sm-2">
						...
						<button type="submit" class="btn btn-primary" id="ReplyBtn" style="width: 100%; margin-top: 5px;">작성</button>
					</div>
				</div>
			</form>
		</div>
