		...
		<div class="card-body">
			<form role="form" method="post" autocomplete="off">
				...
				<div style="margin-top: 10px; text-align: center;">
					<button type="submit" class="btn btn-primary" id="submit" style="margin-right: 10px;">탈퇴하기</button>
					<button type="button" class="btn btn-primary" id="btnCancle" onclick="location.href='/member/update'">취소</button>
				</div>
			</form>
			</div>
		</div>
