		...
		<div class="card-body">
			<form role="form" method="post" autocomplete="off">
				<div class="form-group row">
					...
					<div class="col-md-3">
						<button type="button" class="btn btn-dark idCheck">중복확인</button>
					</div>
				</div>
				...
				<div style="margin-top: 10px; text-align: center;">
					<button type="submit" class="btn btn-dark" id="btnRegister" style="margin-right: 10px;" disabled>회원가입</button>
