	...
	<div class="container text-center" role="main">
		<div class="bg-white rounded shadow-sm">
			<form role="form" method="post" autocomplete="off">
				...
				<p>
					<button type="submit" class="btn btn-dark" style="margin-right: 10px; margin-bottom: 15px;">확인</button>
					<button type="button" id="cancleBtn" class="btn btn-dark" style="margin-bottom: 15px;">취소</button>
