			...
			<div class="replyBody col-md-12">
				<form role="form" method="post" autocomplete="off">
					...
					<div class="replyFooter col-md-12" style="margin-top: 15px; margin-bottom: 15px;">
						<button class="btn btn-dark" type="submit" style="margin-right: 10px; margin-bottom: 15px;">수정</button>
						<button class="btn btn-dark" type="button" id="cancleBtn" style="margin-bottom: 15px;">취소</button>
