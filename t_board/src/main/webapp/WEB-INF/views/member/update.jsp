		...
		<div class="card-body">
			<form role="form" method="post" autocomplete="off">
				...
				<div style="margin-top: 10px; text-align: center;">
					<button type="submit" class="btn btn-primary" id="btnSave" style="margin-right: 10px;">저장</button>
					<button type="button" class="btn btn-primary" id="btnCancle" onclick="location.href='/'">취소</button>
				</div>
			</form>
			</div>
		</div>
		<p><a href="/member/withdraw" style="float: right; margin-top: 5px;">회원탈퇴</a></p>
	</div>
</article>
